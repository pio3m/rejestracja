...
export default function Component() {
  ...
  const therapists = [
    ...
    { id: "2", name: "Anna Kowalska", specialization: "Psycholog dziecięcy", image: "/placeholder.svg?height=150&width=150", available: false },
    { id: "3", name: "Piotr Nowak", specialization: "Terapeuta par", image: "/placeholder.svg?height=150&width=150", available: true },
  ]
